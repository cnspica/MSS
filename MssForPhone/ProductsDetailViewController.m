...
- (void)viewDidLoad {
    [super viewDidLoad];
    api_language=@"cn";
    apistring=[NSString stringWithFormat:@"%@?lang=%@&id=%@",HTTP_getproductimages,api_language,idstring];
...
- (void)requestFinished:(ASIHTTPRequest *)request
{
    if (request.tag==1) {
        ...
        subscroller.contentSize=CGSizeMake(mywidth*pagecontrol.numberOfPages, myheight-100);
